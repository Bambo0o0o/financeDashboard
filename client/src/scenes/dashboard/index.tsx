// Setup 01 : Using shortkey tsrafce 
...
const Dashboard = (props: Props) => {
  ...
  return (
    // Simple setup dashboard page to show it work fine
      // <Box color={palette.grey[300]}>Dashboard</Box>

    // Setup Grid layout as
    ...
    >
      {/* Setup 02 : Setup Dashboard element a to j */}
      {/* Setup "a"-"j" elements */}
...
// Setup 03 : Complete setup and Layout
