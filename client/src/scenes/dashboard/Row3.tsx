  ...
  return (
    ...
    <DashboardBox gridArea="j">
      ...
      <Box
        ...
        borderRadius="1rem"
      > 
        {/* We can change ratio in status bar by increase-decrease width in inner box from 40% to 75% or 40% to 25% */}
        <Box
          height="15px"
